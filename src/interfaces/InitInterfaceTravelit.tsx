...
import viaje from '../images/materials/baseline_flight_takeoff_black_48dp.png'
...
const InitInterface = () => {
    ...
    const img_iconos = [trabajo, educacion, skill, viaje, agenda, telefono, certificado]
    const tittle_iconos = ["Trabajos", "Educación", "Skills", "Viajes", "Agenda", "LLámame", "Certificados"]
    const links_iconos = ["/historia", "/", "/skills", "/travels", "/", "/", "/"]
